...
const Header: React.FC<Prop> = ({ sectionName }) => {
  return (
      ...
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <div className="flex-1 md:flex md:items-center md:gap-12  ">
            <a
              className="block text-teal-600 motion-preset-seesaw hover:motion-preset-flomoji-👍"
              href="/"
            >
          ...
          <div className="md:flex md:items-center md:gap-12">
            ...
            <div className="hidden md:relative md:block ">
              <label className="inline-flex items-center border-2 rounded-full border-black relative  ">
                <input className="peer hidden " id="toggle" type="checkbox" />
                <div
                  className="relative  w-[110px] h-[50px] bg-white peer-checked:bg-zinc-500 
                rounded-full after:absolute after:content-[''] after:w-[40px] after:h-[40px]
