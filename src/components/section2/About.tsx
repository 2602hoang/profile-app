...
export const About = () => {
  return (
    <div className="flex bg-[#333333] gap-5  rounded-2xl shadow-2xl shadow-[#f4f1f1] md:flex-row  p-10 md:min-h-[80vh] flex-col items-center justify-center w-full max-w-screen-xl ">
